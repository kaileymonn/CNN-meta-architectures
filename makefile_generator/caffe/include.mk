...
PROTO       ?= caffe/lenet/lenet.prototxt
MODEL       ?= caffe/lenet/lenet_with_bias.caffemodel
...
TF_OPTS      = --protobuf $(IP_DIR)/$(notdir $(PROTO))	\
			   --inputimages $(IDRA_FILE)	\
			   --iquantized	\
...
ifeq ("$(USE_LOCAL_PARSER)", "1")
	$(eval CAFFE_TOOL = "$(PARSERS_DIR)/caffe/caffeparser.py")
	@chmod +x $(NN_PARSER)
endif
	@echo "CAFFE_TOOL=$(CAFFE_TOOL)"
